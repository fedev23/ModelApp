...
class ScreenClass():
    ...
    def cambiar_name(self, nuevo_nombre_archivo, nuevo_nombre_archivo_completo, file_info):
    ...
    async def load_data(self, file_func, delimiter_func, name_suffix):
        try:
            ...
            if name_suffix == 'validacion':
                ...
                nuevo_nombre_archivo_completo = "Muestra_Validación.txt"
                self.cambiar_name(nuevo_nombre_archivo,
                                  nuevo_nombre_archivo_completo, file_info)
                ...
                nuevo_nombre_archivo_completo = "Muestra_Scoring.txt"
                self.cambiar_name(nuevo_nombre_archivo,
                                  nuevo_nombre_archivo_completo, file_info)
                ...
                nuevo_nombre_archivo_completo = "Muestra_Desarrollo.txt"
                self.cambiar_name(nuevo_nombre_archivo,
                                  nuevo_nombre_archivo_completo, file_info)
